...
#'
plot_vacalib_prior <- function(vacalib_fit, toplot){
      ...
      Mmat_toplot_input[k,,] = do.call("rbind",
                                       lapply(1:dim(Mmat_toplot_input)[2],
                                              FUN = function(i){
                                                ...
                                                smart_round(x = 100*(vacalib_fit$Mmat_input[k,i,]/sum(vacalib_fit$Mmat_input[k,i,])),
          ...
          do.call("rbind",
                  lapply(which(!vacalib_fit$donotcalib_tomodel[k,]),
                         FUN = function(i){
                           ...
                           smart_round(x = 100*(vacalib_fit$Mmat_study[k,i,!vacalib_fit$donotcalib_tomodel[k,]]/sum(vacalib_fit$Mmat_study[k,i,!vacalib_fit$donotcalib_tomodel[k,]])),
                                       target_sum = 100, digits = 0)
          ...
          do.call("rbind",
                  lapply(which(!vacalib_fit$donotcalib_tomodel[k,]),
                         FUN = function(i){
                           ...
                           smart_round(x = 100*(vacalib_fit$Mmat_tomodel[k,i,!vacalib_fit$donotcalib_tomodel[k,]]/sum(vacalib_fit$Mmat_tomodel[k,i,!vacalib_fit$donotcalib_tomodel[k,]])),
                                       target_sum = 100, digits = 0)
